...
// elem.scrollIntoView(top) - прокручивает страницу так, чтобы указанный элемент оказался вверху страницы если top === true,
// а если falsе, то к низу элемента. Если top не указать, то получается, что он по умолчанию true.
